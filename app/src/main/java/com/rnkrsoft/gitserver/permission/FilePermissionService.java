package com.rnkrsoft.gitserver.permission;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.rnkrsoft.gitserver.GitServer;
import com.rnkrsoft.gitserver.Permission;
import com.rnkrsoft.gitserver.PermissionService;
...
public class FilePermissionService implements PermissionService {
    ...
    public boolean hasPermission(String repositoryName, String username, String operate) {
        ...
        try {
            ...
            permission = gson.fromJson(json, Permission.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
        if (permission == null) {
